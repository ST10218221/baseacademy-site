    ...
    <Layout>
      ...
      <section className="relative h-[90vh] flex items-center bg-black text-white overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 opacity-40">
          {/* Using a placeholder for a dark, moody studio or bass guitar close up */}
          {/* unsplash: low key photography of a bass guitar bridge or strings, black and white */}
          <img 
            src="https://images.unsplash.com/photo-1511379938547-c1f69419868d?w=1920&q=80&fit=crop" 
            alt="Bass Guitar Close-up" 
        ...
        <div className="container mx-auto px-4 relative z-10 pt-20">
          <div className="max-w-4xl">
            <h1 className="font-display font-bold text-6xl md:text-8xl lg:text-9xl uppercase tracking-tighter leading-[0.9] mb-6 animate-in fade-in slide-in-from-bottom-8 duration-700">
              Master the <br/>
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
              <Link href="/contact">
                <Button size="lg" className="rounded-none text-lg px-10 py-8 uppercase font-bold tracking-wider bg-white text-black hover:bg-gray-200 border-2 border-white">
                  Book First Lesson
                </Button>
              </Link>
              <Link href="/services">
                <Button size="lg" variant="outline" className="rounded-none text-lg px-10 py-8 uppercase font-bold tracking-wider bg-transparent text-white border-2 border-white hover:bg-white hover:text-black">
                  View Programmes
                </Button>
              </Link>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <Link href="/about">
                <Button variant="link" className="p-0 h-auto text-black font-bold uppercase tracking-widest text-sm hover:text-gray-600 group">
                  Meet Your Instructor <ArrowRight className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-1" />
                </Button>
              </Link>
            </div>
            <div className="relative aspect-[4/5] bg-gray-100">
               {/* unsplash: monochrome portrait of a musician playing bass */}
              <img 
                src="https://images.unsplash.com/photo-1574169208507-84376144848b?w=800&q=80&fit=crop"
                alt="Instructor playing bass" 
            ...
            {[
              ...
              <Link key={idx} href={service.link} className="group cursor-pointer">
                <div className="bg-white p-10 h-full border border-gray-200 transition-all duration-300 hover:shadow-xl hover:border-black flex flex-col">
                  ...
                  <div className="flex items-center text-sm font-bold uppercase tracking-widest mt-auto group-hover:translate-x-2 transition-transform">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col items-center">
              <span className="font-bold uppercase tracking-widest text-lg">James Wilson</span>
              <span className="text-white/50 text-sm mt-1 uppercase tracking-wide">Professional Session Musician</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-32 bg-white text-center">
        <div className="container mx-auto px-4">
          <h2 className="font-display font-bold text-5xl md:text-7xl uppercase tracking-tighter mb-8">
          ...
          <Link href="/contact">
            <Button size="lg" className="rounded-none text-lg px-12 py-8 uppercase font-bold tracking-wider bg-black text-white hover:bg-gray-800">
              Book Your Session
            </Button>
          </Link>
        </div>
